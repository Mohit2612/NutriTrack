...
const FoodSearch = () => {
  ...
  const handleAddToMeal = async (e) => {
    ...
    try {
      ...
      setActiveFood(null);
      setServings(1);
      // Optional: navigate('/meals') or stay on page
    } catch (err) {
          ...
          {foods.map((food) => (
            <div key={food._id} className="card p-3">
              ...
              <div style={{ 
                ...
                <div>
                  <div className="text-light" style={{ fontSize: '0.8rem' }}>Calories</div>
                  <div style={{ fontWeight: '600' }}>{food.calories} kcal</div>
                </div>
                <div>
                  <div className="text-light" style={{ fontSize: '0.8rem' }}>Protein</div>
                  <div style={{ fontWeight: '600' }}>{food.protein} g</div>
                </div>
                <div>
                  <div className="text-light" style={{ fontSize: '0.8rem' }}>Carbs</div>
                  <div style={{ fontWeight: '600' }}>{food.carbohydrates} g</div>
                </div>
                <div>
                  <div className="text-light" style={{ fontSize: '0.8rem' }}>Fats</div>
                  <div style={{ fontWeight: '600' }}>{food.fats} g</div>
                </div>
                <div>
                  <div className="text-light" style={{ fontSize: '0.8rem' }}>Fiber</div>
                  <div style={{ fontWeight: '600' }}>{food.fiber} g</div>
                </div>
              </div>
